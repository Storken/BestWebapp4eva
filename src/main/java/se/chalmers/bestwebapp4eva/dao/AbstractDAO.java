...
public abstract class AbstractDAO<T,K>
     ...
     * 
     * To edit a name, find the entity <pre>old</pre> to be edited and
     * create a new entity <pre>new</pre> as <pre>...(old.getId(), ...)</pre>. 
     * <br> 
     * Then simply call update with <pre>new</pre> as the argument.
    ...
    /**
     * Get a list of entities ranging from first to (inclusive) n.
     * E.g 0-1 will include 0 and 1.
